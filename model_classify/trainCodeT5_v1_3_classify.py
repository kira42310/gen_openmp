...
trainlist = pd.read_pickle('/work/soratouch-p/project/codet5/data/cl_model_train4.pkl')
validlist = pd.read_pickle('/work/soratouch-p/project/codet5/data/cl_model_valid4.pkl')
