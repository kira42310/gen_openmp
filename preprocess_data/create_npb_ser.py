...
npb_location = '/home/mudang/script/npb-prep/NPB-SER/'
...
for bm in npb_files:
    ...
    shutil.copyfile( tmp_cc, home_location + 'raw-cc/' + bm.split('/')[1] + '.ser' )
    ...
    # except:
    #     print( len(ast) )
    pd.DataFrame( data_list ).to_pickle( output_location + bm.split('/')[1] + '.pkl' )